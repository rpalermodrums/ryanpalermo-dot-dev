...
describe('Components', () => {
  describe('DJDeck', () => {
    it('renders two SoundWave components', () => {
      render(<DJDeck />);
      const soundWaves = screen.getAllByRole('img', { name: /Interactive sound wave visualization/i });
  ...
  describe('SoundWave', () => {
    it('renders canvas and upload button', () => {
      render(<SoundWave width={400} height={200} className="" onFileUpload={() => {}} bpm={120} />);
      expect(screen.getByRole('img', { name: /Interactive sound wave visualization/i })).toBeTruthy();
